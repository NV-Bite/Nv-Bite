...
import com.example.NVBite.databinding.ItemEcoFoodRowBinding
import com.example.NVBite.databinding.ItemMapsRowBinding

class EcoFoodAdapter : RecyclerView.Adapter<EcoFoodAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            ItemEcoFoodRowBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        )
    }
    ...
    inner class ViewHolder(var binding: ItemEcoFoodRowBinding) :
